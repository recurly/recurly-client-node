 ...
 */class UniqueCouponCode extends Resource{static getSchema(){return{bulkCouponCode:String,bulkCouponId:String,code:String,createdAt:Date,expiredAt:Date,id:String,object:String,redeemedAt:Date,state:String,updatedAt:Date};}}module.exports=UniqueCouponCode;