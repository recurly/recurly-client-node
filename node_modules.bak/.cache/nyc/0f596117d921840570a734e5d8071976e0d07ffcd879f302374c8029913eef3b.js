 ...
 */class ShippingMethod extends Resource{static getSchema(){return{accountingCode:String,code:String,createdAt:Date,deletedAt:Date,id:String,name:String,object:String,taxCode:String,updatedAt:Date};}}module.exports=ShippingMethod;