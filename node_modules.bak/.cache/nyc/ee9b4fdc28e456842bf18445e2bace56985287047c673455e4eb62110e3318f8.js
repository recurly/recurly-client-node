 ...
 */class CouponRedemption extends Resource{static getSchema(){return{account:'AccountMini',coupon:'Coupon',createdAt:Date,currency:String,discounted:Number,id:String,object:String,removedAt:Date,state:String,updatedAt:Date};}}module.exports=CouponRedemption;