 ...
 */class LineItem extends Resource{static getSchema(){return{account:'AccountMini',accountingCode:String,addOnCode:String,addOnId:String,amount:Number,createdAt:Date,creditApplied:Number,creditReasonCode:String,currency:String,description:String,discount:Number,endDate:Date,id:String,invoiceId:String,invoiceNumber:String,itemCode:String,itemId:String,legacyCategory:String,origin:String,originalLineItemInvoiceId:String,planCode:String,planId:String,previousLineItemId:String,productCode:String,prorationRate:Number,quantity:Number,refund:Boolean,refundedQuantity:Number,revenueScheduleType:String,shippingAddress:'ShippingAddress',startDate:Date,state:String,subscriptionId:String,subtotal:Number,tax:Number,taxCode:String,taxExempt:Boolean,taxInfo:'TaxInfo',taxable:Boolean,type:String,unitAmount:Number,updatedAt:Date,uuid:String};}}module.exports=LineItem;