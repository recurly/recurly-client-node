 ...
 */class Item extends Resource{static getSchema(){return{accountingCode:String,code:String,createdAt:Date,currencies:['Pricing'],customFields:['CustomField'],deletedAt:Date,description:String,externalSku:String,id:String,name:String,revenueScheduleType:String,state:String,taxCode:String,taxExempt:Boolean,updatedAt:Date};}}module.exports=Item;