 ...
 */class ShippingMethod extends Resource{static getSchema(){return{code:String,createdAt:Date,deletedAt:Date,id:String,name:String,taxCode:String,updatedAt:Date};}}module.exports=ShippingMethod;