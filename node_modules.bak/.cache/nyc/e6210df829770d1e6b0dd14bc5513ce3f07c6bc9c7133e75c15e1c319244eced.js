 ...
 */class CouponMini extends Resource{static getSchema(){return{code:String,couponType:String,discount:'CouponDiscount',expiredAt:Date,id:String,name:String,object:String,state:String};}}module.exports=CouponMini;