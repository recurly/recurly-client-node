 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */async previewPurchase(body,options={}){let path='/purchases/preview';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}}module.exports=Client;