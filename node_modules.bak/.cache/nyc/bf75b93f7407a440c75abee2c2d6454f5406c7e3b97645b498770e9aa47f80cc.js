 ...
 */class Usage extends Resource{static getSchema(){return{amount:Number,billedAt:Date,createdAt:Date,id:String,measuredUnitId:String,merchantTag:String,object:String,recordingTimestamp:Date,tierType:String,tiers:['SubscriptionAddOnTier'],unitAmount:Number,updatedAt:Date,usagePercentage:Number,usageTimestamp:Date,usageType:String};}}module.exports=Usage;