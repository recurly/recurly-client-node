 ...
 */class Account extends Resource{static getSchema(){return{address:'Address',billTo:String,billingInfo:'BillingInfo',ccEmails:String,code:String,company:String,createdAt:Date,customFields:['CustomField'],deletedAt:Date,email:String,exemptionCertificate:String,firstName:String,hostedLoginToken:String,id:String,lastName:String,parentAccountId:String,preferredLocale:String,shippingAddresses:['ShippingAddress'],state:String,taxExempt:Boolean,updatedAt:Date,username:String,vatNumber:String};}}module.exports=Account;