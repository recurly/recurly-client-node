 ...
 */class AddOnMini extends Resource{static getSchema(){return{accountingCode:String,code:String,externalSku:String,id:String,itemId:String,name:String,object:String};}}module.exports=AddOnMini;