 ...
 */class AddOn extends Resource{static getSchema(){return{accountingCode:String,code:String,createdAt:Date,currencies:['AddOnPricing'],defaultQuantity:Number,deletedAt:Date,displayQuantity:Boolean,id:String,name:String,planId:String,state:String,taxCode:String,updatedAt:Date};}}module.exports=AddOn;