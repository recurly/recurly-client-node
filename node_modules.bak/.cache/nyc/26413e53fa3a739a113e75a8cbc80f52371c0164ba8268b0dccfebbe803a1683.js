 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */async recordExternalTransaction(invoiceId,body){let path='/invoices/{invoice_id}/transactions';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('POST',path,body);}/**
