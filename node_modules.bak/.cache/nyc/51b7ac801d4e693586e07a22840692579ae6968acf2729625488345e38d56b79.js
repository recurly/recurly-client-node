 ...
 */class AccountMini extends Resource{static getSchema(){return{billTo:String,code:String,company:String,email:String,firstName:String,id:String,lastName:String,object:String,parentAccountId:String};}}module.exports=AccountMini;