 ...
 */class Site extends Resource{static getSchema(){return{address:'Address',createdAt:Date,deletedAt:Date,features:Array,id:String,mode:String,object:String,publicApiKey:String,settings:'Settings',subdomain:String,updatedAt:Date};}}module.exports=Site;