 ...
 */class PaymentMethod extends Resource{static getSchema(){return{accountType:String,billingAgreementId:String,cardType:String,expMonth:Number,expYear:Number,firstSix:String,lastFour:String,object:String,routingNumber:String,routingNumberBank:String};}}module.exports=PaymentMethod;