 ...
 */class AccountUpdate extends Resource{static getSchema(){return{address:'Address',billTo:String,billingInfo:'BillingInfoCreate',ccEmails:String,company:String,customFields:['CustomField'],email:String,exemptionCertificate:String,firstName:String,lastName:String,parentAccountCode:String,parentAccountId:String,preferredLocale:String,taxExempt:Boolean,transactionType:String,username:String,vatNumber:String};}}module.exports=AccountUpdate;