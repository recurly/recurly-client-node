 ...
 */class InvoiceAddress{static getSchema(){return{city:String,company:String,country:String,firstName:String,lastName:String,nameOnAccount:String,phone:String,postalCode:String,region:String,street1:String,street2:String};}}module.exports=InvoiceAddress;