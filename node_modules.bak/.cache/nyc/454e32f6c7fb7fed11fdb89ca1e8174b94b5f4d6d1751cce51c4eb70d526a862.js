 ...
 */class AddOnMini extends Resource{static getSchema(){return{accountingCode:String,addOnType:String,code:String,externalSku:String,id:String,itemId:String,measuredUnitId:String,name:String,object:String,usagePercentage:Number,usageType:String};}}module.exports=AddOnMini;