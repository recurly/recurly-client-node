 ...
 */class TransactionError extends Resource{static getSchema(){return{category:String,code:String,merchantAdvice:String,message:String,object:String,threeDSecureActionTokenId:String,transactionId:String};}}module.exports=TransactionError;