 ...
 */class Plan extends Resource{static getSchema(){return{accountingCode:String,autoRenew:Boolean,code:String,createdAt:Date,currencies:['PlanPricing'],deletedAt:Date,description:String,hostedPages:'PlanHostedPages',id:String,intervalLength:Number,intervalUnit:String,name:String,object:String,setupFeeAccountingCode:String,state:String,taxCode:String,taxExempt:Boolean,totalBillingCycles:Number,trialLength:Number,trialUnit:String,updatedAt:Date};}}module.exports=Plan;