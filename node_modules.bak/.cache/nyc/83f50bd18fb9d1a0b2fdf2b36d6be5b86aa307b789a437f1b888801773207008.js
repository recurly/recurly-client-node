 ...
 */class PlanCreate extends Resource{static getSchema(){return{accountingCode:String,addOns:['AddOnCreate'],allowAnyItemOnSubscriptions:Boolean,autoRenew:Boolean,avalaraServiceType:Number,avalaraTransactionType:Number,code:String,currencies:['PlanPricing'],description:String,hostedPages:'PlanHostedPages',intervalLength:Number,intervalUnit:String,name:String,revenueScheduleType:String,setupFeeAccountingCode:String,setupFeeRevenueScheduleType:String,taxCode:String,taxExempt:Boolean,totalBillingCycles:Number,trialLength:Number,trialRequiresBillingInfo:Boolean,trialUnit:String};}}module.exports=PlanCreate;