 ...
 * @prop {Array.<ShippingAddressCreate>} shippingAddresses
 ...
 */class AccountCreate extends Resource{static getSchema(){return{acquisition:'AccountAcquisitionUpdatable',address:'Address',billTo:String,billingInfo:'BillingInfoCreate',ccEmails:String,code:String,company:String,customFields:['CustomField'],email:String,exemptionCertificate:String,firstName:String,lastName:String,parentAccountCode:String,parentAccountId:String,preferredLocale:String,shippingAddresses:['ShippingAddressCreate'],taxExempt:Boolean,transactionType:String,username:String,vatNumber:String};}}module.exports=AccountCreate;