 ...
 */class Address{static getSchema(){return{city:String,country:String,firstName:String,lastName:String,phone:String,postalCode:String,region:String,street1:String,street2:String};}}module.exports=Address;