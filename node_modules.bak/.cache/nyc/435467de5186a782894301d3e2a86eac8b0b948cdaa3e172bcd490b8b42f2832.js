 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/generate_unique_coupon_codes}
   *
   *
   * @param {string} couponId - Coupon ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-10off`.
   ...
   * @return {Promise<Empty>} The `Location` header will specify the location created coupon codes
   */async generateUniqueCouponCodes(couponId,body,options={}){let path='/coupons/{coupon_id}/generate';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('POST',path,body,options);}/**
