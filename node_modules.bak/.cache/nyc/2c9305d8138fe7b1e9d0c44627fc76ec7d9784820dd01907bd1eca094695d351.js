 ...
 */class AddOn extends Resource{static getSchema(){return{accountingCode:String,addOnType:String,avalaraServiceType:Number,avalaraTransactionType:Number,code:String,createdAt:Date,currencies:['AddOnPricing'],defaultQuantity:Number,deletedAt:Date,displayQuantity:Boolean,externalSku:String,id:String,item:'ItemMini',measuredUnitId:String,name:String,object:String,optional:Boolean,planId:String,revenueScheduleType:String,state:String,taxCode:String,tierType:String,tiers:['Tier'],updatedAt:Date,usagePercentage:Number,usageType:String};}}module.exports=AddOn;