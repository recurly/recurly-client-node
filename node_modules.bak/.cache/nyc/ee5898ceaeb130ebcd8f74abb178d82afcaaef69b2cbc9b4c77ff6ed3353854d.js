 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */listBillingInfos(accountId,options={}){let path='/accounts/{account_id}/billing_infos';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,options);}/**
   ...
   * @param {string} billingInfoId - Billing Info ID.
   * @return {Promise<Empty>} Billing information deleted
   */async removeABillingInfo(accountId,billingInfoId,options={}){let path='/accounts/{account_id}/billing_infos/{billing_info_id}';path=this._interpolatePath(path,{'account_id':accountId,'billing_info_id':billingInfoId});return this._makeRequest('DELETE',path,null,options);}/**
