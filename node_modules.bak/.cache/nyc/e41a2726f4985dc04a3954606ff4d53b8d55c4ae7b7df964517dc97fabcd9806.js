 ...
 */class ItemUpdate extends Resource{static getSchema(){return{accountingCode:String,avalaraServiceType:Number,avalaraTransactionType:Number,code:String,currencies:['Pricing'],customFields:['CustomField'],description:String,externalSku:String,name:String,revenueScheduleType:String,taxCode:String,taxExempt:Boolean};}}module.exports=ItemUpdate;