 ...
 * @prop {string} chargeCustomerNotes - This will default to the Customer Notes text specified on the Invoice Settings for charge invoices. Specify custom notes to add or override Customer Notes on charge invoices.
 ...
 * @prop {string} creditCustomerNotes - This will default to the Customer Notes text specified on the Invoice Settings for credit invoices. Specify customer notes to add or override Customer Notes on credit invoices.
 ...
 */class InvoiceCreate{static getSchema(){return{chargeCustomerNotes:String,collectionMethod:String,creditCustomerNotes:String,currency:String,netTerms:Number,poNumber:String,termsAndConditions:String,vatReverseChargeNotes:String};}}module.exports=InvoiceCreate;