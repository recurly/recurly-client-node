 ...
 */class CreditPayment extends Resource{static getSchema(){return{account:'AccountMini',action:String,amount:Number,appliedToInvoice:'InvoiceMini',createdAt:Date,currency:String,id:String,originalCreditPaymentId:String,originalInvoice:'InvoiceMini',refundTransaction:'Transaction',updatedAt:Date,uuid:String,voidedAt:Date};}}module.exports=CreditPayment;