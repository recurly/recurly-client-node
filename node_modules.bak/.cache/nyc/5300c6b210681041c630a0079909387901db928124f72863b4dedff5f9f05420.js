 ...
 */class ShippingAddress extends Resource{static getSchema(){return{accountId:String,city:String,company:String,country:String,createdAt:Date,email:String,firstName:String,id:String,lastName:String,nickname:String,phone:String,postalCode:String,region:String,street1:String,street2:String,updatedAt:Date,vatNumber:String};}}module.exports=ShippingAddress;