 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */listSites(params={}){let path='/sites';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Fetch a site
   *
   ...
   */listAccounts(params={}){let path='/accounts';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Create an account
   *
   ...
   */async removeAccountAcquisition(accountId){let path='/accounts/{account_id}/acquisition';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,{expectedContentType:''});}/**
   ...
   */async removeBillingInfo(accountId){let path='/accounts/{account_id}/billing_info';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,{expectedContentType:''});}/**
   ...
   */listAccountCouponRedemptions(accountId,params={}){let path='/accounts/{account_id}/coupon_redemptions';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountCreditPayments(accountId,params={}){let path='/accounts/{account_id}/credit_payments';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountInvoices(accountId,params={}){let path='/accounts/{account_id}/invoices';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountLineItems(accountId,params={}){let path='/accounts/{account_id}/line_items';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountNotes(accountId,params={}){let path='/accounts/{account_id}/notes';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listShippingAddresses(accountId,params={}){let path='/accounts/{account_id}/shipping_addresses';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */async removeShippingAddress(accountId,shippingAddressId){let path='/accounts/{account_id}/shipping_addresses/{shipping_address_id}';path=this._interpolatePath(path,{'account_id':accountId,'shipping_address_id':shippingAddressId});return this._makeRequest('DELETE',path,null,{expectedContentType:''});}/**
   ...
   */listAccountSubscriptions(accountId,params={}){let path='/accounts/{account_id}/subscriptions';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountTransactions(accountId,params={}){let path='/accounts/{account_id}/transactions';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listChildAccounts(accountId,params={}){let path='/accounts/{account_id}/accounts';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,params);}/**
   ...
   */listAccountAcquisition(params={}){let path='/acquisitions';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   ...
   */listCoupons(params={}){let path='/coupons';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Create a new coupon
   *
   ...
   */listUniqueCouponCodes(couponId,params={}){let path='/coupons/{coupon_id}/unique_coupon_codes';path=this._interpolatePath(path,{'coupon_id':couponId});return new Pager(this,path,params);}/**
   ...
   */listCreditPayments(params={}){let path='/credit_payments';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   ...
   */listCustomFieldDefinitions(params={}){let path='/custom_field_definitions';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   ...
   */listInvoices(params={}){let path='/invoices';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Fetch an invoice
   *
   ...
   *   fs.writeFileSync('/tmp/nodeinvoice.pdf', invoice.data, 'binary')
   * } catch (err) {
   *   if (err instanceof recurly.errors.NotFoundError) {
   *     // If the request was not found, you may want to alert the user or
   *     // just return null
   ...
   *
   * @param {string} invoiceId - Invoice ID or number. For ID no prefix is used e.g. `e28zov4fw0v2`. For number use prefix `number-`, e.g. `number-1000`.
   * @return {Promise<File>} An invoice as a PDF.
   */async getInvoicePdf(invoiceId){let path='/invoices/{invoice_id}.pdf';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('GET',path,null,{expectedContentType:'application/pdf'});}/**
   ...
   */async collectInvoice(invoiceId,params={}){let path='/invoices/{invoice_id}/collect';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,null);}/**
   ...
   */listInvoiceLineItems(invoiceId,params={}){let path='/invoices/{invoice_id}/line_items';path=this._interpolatePath(path,{'invoice_id':invoiceId});return new Pager(this,path,params);}/**
   ...
   */listInvoiceCouponRedemptions(invoiceId,params={}){let path='/invoices/{invoice_id}/coupon_redemptions';path=this._interpolatePath(path,{'invoice_id':invoiceId});return new Pager(this,path,params);}/**
   ...
   */listRelatedInvoices(invoiceId,params={}){let path='/invoices/{invoice_id}/related_invoices';path=this._interpolatePath(path,{'invoice_id':invoiceId});return new Pager(this,path,params);}/**
   * Refund an invoice
   *
   ...
   */listLineItems(params={}){let path='/line_items';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Fetch a line item
   *
   ...
   */async removeLineItem(lineItemId){let path='/line_items/{line_item_id}';path=this._interpolatePath(path,{'line_item_id':lineItemId});return this._makeRequest('DELETE',path,null,{expectedContentType:''});}/**
   * List a site's plans
   *
   ...
   */listPlans(params={}){let path='/plans';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Create a plan
   *
   ...
   */listPlanAddOns(planId,params={}){let path='/plans/{plan_id}/add_ons';path=this._interpolatePath(path,{'plan_id':planId});return new Pager(this,path,params);}/**
   * Create an add-on
   *
   ...
   * @param {string} params.state - Filter by state.
   * @return {Pager<AddOn>} A list of add-ons.
   */listAddOns(params={}){let path='/add_ons';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Fetch an add-on
   *
   ...
   */listShippingMethods(params={}){let path='/shipping_methods';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   ...
   */listSubscriptions(params={}){let path='/subscriptions';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   ...
   */async terminateSubscription(subscriptionId,params={}){let path='/subscriptions/{subscription_id}';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('DELETE',path,null);}/**
   ...
   */async cancelSubscription(subscriptionId,params={}){let path='/subscriptions/{subscription_id}/cancel';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,null);}/**
   ...
   */async removeSubscriptionChange(subscriptionId){let path='/subscriptions/{subscription_id}/change';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('DELETE',path,null,{expectedContentType:''});}/**
   ...
   */listSubscriptionInvoices(subscriptionId,params={}){let path='/subscriptions/{subscription_id}/invoices';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return new Pager(this,path,params);}/**
   ...
   */listSubscriptionLineItems(subscriptionId,params={}){let path='/subscriptions/{subscription_id}/line_items';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return new Pager(this,path,params);}/**
   ...
   */listSubscriptionCouponRedemptions(subscriptionId,params={}){let path='/subscriptions/{subscription_id}/coupon_redemptions';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return new Pager(this,path,params);}/**
   ...
   */listTransactions(params={}){let path='/transactions';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Fetch a transaction
   *
