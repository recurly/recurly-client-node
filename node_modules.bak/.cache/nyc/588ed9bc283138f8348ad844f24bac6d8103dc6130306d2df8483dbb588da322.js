 ...
 */class BillingInfo extends Resource{static getSchema(){return{accountId:String,address:'Address',company:String,createdAt:Date,firstName:String,fraud:'FraudInfo',id:String,lastName:String,object:String,paymentMethod:'PaymentMethod',updatedAt:Date,updatedBy:'BillingInfoUpdatedBy',valid:Boolean,vatNumber:String};}}module.exports=BillingInfo;