 ...
 * @prop {string} planCode - If you want to change to a new plan, you can provide the plan's code or id. If both are provided the `plan_id` will be used.
 * @prop {string} planId - If you want to change to a new plan, you can provide the plan's code or id. If both are provided the `plan_id` will be used.
 ...
 * @prop {number} unitAmount - Optionally, sets custom pricing for the subscription, overriding the plan's default unit amount. The subscription's current currency will be used.
 */class SubscriptionChangeCreate extends Resource{static getSchema(){return{addOns:['SubscriptionAddOnUpdate'],collectionMethod:String,couponCodes:Array,customFields:['CustomField'],netTerms:Number,planCode:String,planId:String,poNumber:String,quantity:Number,revenueScheduleType:String,shipping:'SubscriptionChangeShippingCreate',timeframe:String,transactionType:String,unitAmount:Number};}}module.exports=SubscriptionChangeCreate;