 ...
 */class Plan extends Resource{static getSchema(){return{accountingCode:String,allowAnyItemOnSubscriptions:Boolean,autoRenew:Boolean,avalaraServiceType:Number,avalaraTransactionType:Number,code:String,createdAt:Date,currencies:['PlanPricing'],deletedAt:Date,description:String,hostedPages:'PlanHostedPages',id:String,intervalLength:Number,intervalUnit:String,name:String,object:String,revenueScheduleType:String,setupFeeAccountingCode:String,setupFeeRevenueScheduleType:String,state:String,taxCode:String,taxExempt:Boolean,totalBillingCycles:Number,trialLength:Number,trialRequiresBillingInfo:Boolean,trialUnit:String,updatedAt:Date};}}module.exports=Plan;