 ...
 */class SubscriptionAddOn extends Resource{static getSchema(){return{addOn:'AddOnMini',addOnSource:String,createdAt:Date,expiredAt:Date,id:String,object:String,quantity:Number,revenueScheduleType:String,subscriptionId:String,tierType:String,tiers:['SubscriptionAddOnTier'],unitAmount:Number,updatedAt:Date,usagePercentage:Number};}}module.exports=SubscriptionAddOn;