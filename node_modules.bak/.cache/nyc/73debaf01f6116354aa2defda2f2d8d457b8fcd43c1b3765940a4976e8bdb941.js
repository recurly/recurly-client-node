 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */async getSite(siteId,options={}){let path='/sites/{site_id}';path=this._interpolatePath(path,{'site_id':siteId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async createAccount(body,options={}){let path='/accounts';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   * Fetch an account
   *
   ...
   * @return {Promise<Account>} An account.
   */async getAccount(accountId,options={}){let path='/accounts/{account_id}';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('GET',path,null,options);}/**
   * Modify an account
   *
   ...
   * @return {Promise<Account>} An account.
   */async updateAccount(accountId,body,options={}){let path='/accounts/{account_id}';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @return {Promise<Account>} An account.
   */async deactivateAccount(accountId,options={}){let path='/accounts/{account_id}';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async getAccountAcquisition(accountId,options={}){let path='/accounts/{account_id}/acquisition';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateAccountAcquisition(accountId,body,options={}){let path='/accounts/{account_id}/acquisition';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async removeAccountAcquisition(accountId,options={}){let path='/accounts/{account_id}/acquisition';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @return {Promise<Account>} An account.
   */async reactivateAccount(accountId,options={}){let path='/accounts/{account_id}/reactivate';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   */async getAccountBalance(accountId,options={}){let path='/accounts/{account_id}/balance';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async getBillingInfo(accountId,options={}){let path='/accounts/{account_id}/billing_info';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateBillingInfo(accountId,body,options={}){let path='/accounts/{account_id}/billing_info';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async removeBillingInfo(accountId,options={}){let path='/accounts/{account_id}/billing_info';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */getBillingInfos(accountId,options={}){let path='/accounts/{account_id}/billing_infos';path=this._interpolatePath(path,{'account_id':accountId});return new Pager(this,path,options);}/**
   ...
   * @param {BillingInfoCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {BillingInfoCreate}
   * @return {Promise<BillingInfo>} Updated billing information.
   */async createBillingInfo(accountId,body,options={}){let path='/accounts/{account_id}/billing_infos';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getABillingInfo(accountId,billingInfoId,options={}){let path='/accounts/{account_id}/billing_infos/{billing_info_id}';path=this._interpolatePath(path,{'account_id':accountId,'billing_info_id':billingInfoId});return this._makeRequest('GET',path,null,options);}/**
   ...
   * @param {BillingInfoCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {BillingInfoCreate}
   * @return {Promise<BillingInfo>} Updated billing information.
   */async updateABillingInfo(accountId,billingInfoId,body,options={}){let path='/accounts/{account_id}/billing_infos/{billing_info_id}';path=this._interpolatePath(path,{'account_id':accountId,'billing_info_id':billingInfoId});return this._makeRequest('PUT',path,body,options);}/**
   * Remove an account's billing information
   *
   ...
   * @param {string} billingInfoId - Billing Info ID.
   * @return {Promise<Empty>} Billing information deleted
   */async removeOneBillingInfo(accountId,billingInfoId,options={}){let path='/accounts/{account_id}/billing_infos/{billing_info_id}';path=this._interpolatePath(path,{'account_id':accountId,'billing_info_id':billingInfoId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async getActiveCouponRedemption(accountId,options={}){let path='/accounts/{account_id}/coupon_redemptions/active';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async createCouponRedemption(accountId,body,options={}){let path='/accounts/{account_id}/coupon_redemptions/active';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async removeCouponRedemption(accountId,options={}){let path='/accounts/{account_id}/coupon_redemptions/active';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async createInvoice(accountId,body,options={}){let path='/accounts/{account_id}/invoices';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async previewInvoice(accountId,body,options={}){let path='/accounts/{account_id}/invoices/preview';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async createLineItem(accountId,body,options={}){let path='/accounts/{account_id}/line_items';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getAccountNote(accountId,accountNoteId,options={}){let path='/accounts/{account_id}/notes/{account_note_id}';path=this._interpolatePath(path,{'account_id':accountId,'account_note_id':accountNoteId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async createShippingAddress(accountId,body,options={}){let path='/accounts/{account_id}/shipping_addresses';path=this._interpolatePath(path,{'account_id':accountId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getShippingAddress(accountId,shippingAddressId,options={}){let path='/accounts/{account_id}/shipping_addresses/{shipping_address_id}';path=this._interpolatePath(path,{'account_id':accountId,'shipping_address_id':shippingAddressId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateShippingAddress(accountId,shippingAddressId,body,options={}){let path='/accounts/{account_id}/shipping_addresses/{shipping_address_id}';path=this._interpolatePath(path,{'account_id':accountId,'shipping_address_id':shippingAddressId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async removeShippingAddress(accountId,shippingAddressId,options={}){let path='/accounts/{account_id}/shipping_addresses/{shipping_address_id}';path=this._interpolatePath(path,{'account_id':accountId,'shipping_address_id':shippingAddressId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async createCoupon(body,options={}){let path='/coupons';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   * Fetch a coupon
   *
   ...
   */async getCoupon(couponId,options={}){let path='/coupons/{coupon_id}';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateCoupon(couponId,body,options={}){let path='/coupons/{coupon_id}';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('PUT',path,body,options);}/**
   * Expire a coupon
   *
   ...
   */async deactivateCoupon(couponId,options={}){let path='/coupons/{coupon_id}';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async restoreCoupon(couponId,body,options={}){let path='/coupons/{coupon_id}/restore';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async getCreditPayment(creditPaymentId,options={}){let path='/credit_payments/{credit_payment_id}';path=this._interpolatePath(path,{'credit_payment_id':creditPaymentId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async getCustomFieldDefinition(customFieldDefinitionId,options={}){let path='/custom_field_definitions/{custom_field_definition_id}';path=this._interpolatePath(path,{'custom_field_definition_id':customFieldDefinitionId});return this._makeRequest('GET',path,null,options);}/**
   * List a site's items
   *
   ...
   */async createItem(body,options={}){let path='/items';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   * Fetch an item
   *
   ...
   */async getItem(itemId,options={}){let path='/items/{item_id}';path=this._interpolatePath(path,{'item_id':itemId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateItem(itemId,body,options={}){let path='/items/{item_id}';path=this._interpolatePath(path,{'item_id':itemId});return this._makeRequest('PUT',path,body,options);}/**
   * Deactivate an item
   *
   ...
   * @param {string} itemId - Item ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-red`.
   * @return {Promise<Item>} An item.
   */async deactivateItem(itemId,options={}){let path='/items/{item_id}';path=this._interpolatePath(path,{'item_id':itemId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   * @param {string} itemId - Item ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-red`.
   * @return {Promise<Item>} An item.
   */async reactivateItem(itemId,options={}){let path='/items/{item_id}/reactivate';path=this._interpolatePath(path,{'item_id':itemId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   */listMeasuredUnit(options={}){let path='/measured_units';path=this._interpolatePath(path);return new Pager(this,path,options);}/**
   ...
   */async createMeasuredUnit(body,options={}){let path='/measured_units';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getMeasuredUnit(measuredUnitId,options={}){let path='/measured_units/{measured_unit_id}';path=this._interpolatePath(path,{'measured_unit_id':measuredUnitId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateMeasuredUnit(measuredUnitId,body,options={}){let path='/measured_units/{measured_unit_id}';path=this._interpolatePath(path,{'measured_unit_id':measuredUnitId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async removeMeasuredUnit(measuredUnitId,options={}){let path='/measured_units/{measured_unit_id}';path=this._interpolatePath(path,{'measured_unit_id':measuredUnitId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async getInvoice(invoiceId,options={}){let path='/invoices/{invoice_id}';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('GET',path,null,options);}/**
   * Update an invoice
   *
   ...
   * @return {Promise<Invoice>} An invoice.
   */async putInvoice(invoiceId,body,options={}){let path='/invoices/{invoice_id}';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async getInvoicePdf(invoiceId,options={}){let path='/invoices/{invoice_id}.pdf';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('GET',path,null,options);}/**
   ...
   * @param {string} invoiceId - Invoice ID or number. For ID no prefix is used e.g. `e28zov4fw0v2`. For number use prefix `number-`, e.g. `number-1000`.
   * @return {Promise<Invoice>} The updated invoice.
   */async failInvoice(invoiceId,options={}){let path='/invoices/{invoice_id}/mark_failed';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   * @param {string} invoiceId - Invoice ID or number. For ID no prefix is used e.g. `e28zov4fw0v2`. For number use prefix `number-`, e.g. `number-1000`.
   * @return {Promise<Invoice>} The updated invoice.
   */async markInvoiceSuccessful(invoiceId,options={}){let path='/invoices/{invoice_id}/mark_successful';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   * @param {string} invoiceId - Invoice ID or number. For ID no prefix is used e.g. `e28zov4fw0v2`. For number use prefix `number-`, e.g. `number-1000`.
   * @return {Promise<Invoice>} The updated invoice.
   */async reopenInvoice(invoiceId,options={}){let path='/invoices/{invoice_id}/reopen';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   * @param {string} invoiceId - Invoice ID or number. For ID no prefix is used e.g. `e28zov4fw0v2`. For number use prefix `number-`, e.g. `number-1000`.
   * @return {Promise<Invoice>} The updated invoice.
   */async voidInvoice(invoiceId,options={}){let path='/invoices/{invoice_id}/void';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   */async recordExternalTransaction(invoiceId,body,options={}){let path='/invoices/{invoice_id}/transactions';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async refundInvoice(invoiceId,body,options={}){let path='/invoices/{invoice_id}/refund';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getLineItem(lineItemId,options={}){let path='/line_items/{line_item_id}';path=this._interpolatePath(path,{'line_item_id':lineItemId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async removeLineItem(lineItemId,options={}){let path='/line_items/{line_item_id}';path=this._interpolatePath(path,{'line_item_id':lineItemId});return this._makeRequest('DELETE',path,null,options);}/**
   * List a site's plans
   *
   ...
   */async createPlan(body,options={}){let path='/plans';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   * Fetch a plan
   *
   ...
   * @return {Promise<Plan>} A plan.
   */async getPlan(planId,options={}){let path='/plans/{plan_id}';path=this._interpolatePath(path,{'plan_id':planId});return this._makeRequest('GET',path,null,options);}/**
   * Update a plan
   *
   ...
   * @return {Promise<Plan>} A plan.
   */async updatePlan(planId,body,options={}){let path='/plans/{plan_id}';path=this._interpolatePath(path,{'plan_id':planId});return this._makeRequest('PUT',path,body,options);}/**
   * Remove a plan
   *
   ...
   */async removePlan(planId,options={}){let path='/plans/{plan_id}';path=this._interpolatePath(path,{'plan_id':planId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async createPlanAddOn(planId,body,options={}){let path='/plans/{plan_id}/add_ons';path=this._interpolatePath(path,{'plan_id':planId});return this._makeRequest('POST',path,body,options);}/**
   ...
   * @return {Promise<AddOn>} An add-on.
   */async getPlanAddOn(planId,addOnId,options={}){let path='/plans/{plan_id}/add_ons/{add_on_id}';path=this._interpolatePath(path,{'plan_id':planId,'add_on_id':addOnId});return this._makeRequest('GET',path,null,options);}/**
   * Update an add-on
   *
   ...
   * @return {Promise<AddOn>} An add-on.
   */async updatePlanAddOn(planId,addOnId,body,options={}){let path='/plans/{plan_id}/add_ons/{add_on_id}';path=this._interpolatePath(path,{'plan_id':planId,'add_on_id':addOnId});return this._makeRequest('PUT',path,body,options);}/**
   * Remove an add-on
   *
   ...
   */async removePlanAddOn(planId,addOnId,options={}){let path='/plans/{plan_id}/add_ons/{add_on_id}';path=this._interpolatePath(path,{'plan_id':planId,'add_on_id':addOnId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   * @param {string} addOnId - Add-on ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-gold`.
   * @return {Promise<AddOn>} An add-on.
   */async getAddOn(addOnId,options={}){let path='/add_ons/{add_on_id}';path=this._interpolatePath(path,{'add_on_id':addOnId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async createShippingMethod(body,options={}){let path='/shipping_methods';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getShippingMethod(id,options={}){let path='/shipping_methods/{id}';path=this._interpolatePath(path,{'id':id});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateShippingMethod(shippingMethodId,body,options={}){let path='/shipping_methods/{shipping_method_id}';path=this._interpolatePath(path,{'shipping_method_id':shippingMethodId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   * @param {string} shippingMethodId - Shipping Method ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-usps_2-day`.
   * @return {Promise<ShippingMethod>} A shipping method.
   */async deactivateShippingMethod(shippingMethodId,options={}){let path='/shipping_methods/{shipping_method_id}';path=this._interpolatePath(path,{'shipping_method_id':shippingMethodId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async createSubscription(body,options={}){let path='/subscriptions';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   ...
   * @return {Promise<Subscription>} A subscription.
   */async getSubscription(subscriptionId,options={}){let path='/subscriptions/{subscription_id}';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('GET',path,null,options);}/**
   ...
   * @return {Promise<Subscription>} A subscription.
   */async modifySubscription(subscriptionId,body,options={}){let path='/subscriptions/{subscription_id}';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async reactivateSubscription(subscriptionId,options={}){let path='/subscriptions/{subscription_id}/reactivate';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,null,options);}/**
   * Pause subscription
   *
   ...
   * @return {Promise<Subscription>} A subscription.
   */async pauseSubscription(subscriptionId,body,options={}){let path='/subscriptions/{subscription_id}/pause';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,body,options);}/**
   * Resume subscription
   *
   ...
   * @param {string} subscriptionId - Subscription ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @return {Promise<Subscription>} A subscription.
   */async resumeSubscription(subscriptionId,options={}){let path='/subscriptions/{subscription_id}/resume';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   * @param {string} subscriptionId - Subscription ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @return {Promise<Subscription>} A subscription.
   */async convertTrial(subscriptionId,options={}){let path='/subscriptions/{subscription_id}/convert_trial';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   */async getSubscriptionChange(subscriptionId,options={}){let path='/subscriptions/{subscription_id}/change';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async createSubscriptionChange(subscriptionId,body,options={}){let path='/subscriptions/{subscription_id}/change';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */async removeSubscriptionChange(subscriptionId,options={}){let path='/subscriptions/{subscription_id}/change';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async previewSubscriptionChange(subscriptionId,body,options={}){let path='/subscriptions/{subscription_id}/change/preview';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('POST',path,body,options);}/**
   ...
   */listUsage(subscriptionId,addOnId,options={}){let path='/subscriptions/{subscription_id}/add_ons/{add_on_id}/usage';path=this._interpolatePath(path,{'subscription_id':subscriptionId,'add_on_id':addOnId});return new Pager(this,path,options);}/**
   ...
   */async createUsage(subscriptionId,addOnId,body,options={}){let path='/subscriptions/{subscription_id}/add_ons/{add_on_id}/usage';path=this._interpolatePath(path,{'subscription_id':subscriptionId,'add_on_id':addOnId});return this._makeRequest('POST',path,body,options);}/**
   * Get a usage record
   *
   ...
   */async getUsage(usageId,options={}){let path='/usage/{usage_id}';path=this._interpolatePath(path,{'usage_id':usageId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async updateUsage(usageId,body,options={}){let path='/usage/{usage_id}';path=this._interpolatePath(path,{'usage_id':usageId});return this._makeRequest('PUT',path,body,options);}/**
   ...
   */async removeUsage(usageId,options={}){let path='/usage/{usage_id}';path=this._interpolatePath(path,{'usage_id':usageId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   */async getTransaction(transactionId,options={}){let path='/transactions/{transaction_id}';path=this._interpolatePath(path,{'transaction_id':transactionId});return this._makeRequest('GET',path,null,options);}/**
   ...
   */async getUniqueCouponCode(uniqueCouponCodeId,options={}){let path='/unique_coupon_codes/{unique_coupon_code_id}';path=this._interpolatePath(path,{'unique_coupon_code_id':uniqueCouponCodeId});return this._makeRequest('GET',path,null,options);}/**
   ...
   * @param {string} uniqueCouponCodeId - Unique Coupon Code ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-abc-8dh2-def`.
   * @return {Promise<UniqueCouponCode>} A unique coupon code.
   */async deactivateUniqueCouponCode(uniqueCouponCodeId,options={}){let path='/unique_coupon_codes/{unique_coupon_code_id}';path=this._interpolatePath(path,{'unique_coupon_code_id':uniqueCouponCodeId});return this._makeRequest('DELETE',path,null,options);}/**
   ...
   * @param {string} uniqueCouponCodeId - Unique Coupon Code ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-abc-8dh2-def`.
   * @return {Promise<UniqueCouponCode>} A unique coupon code.
   */async reactivateUniqueCouponCode(uniqueCouponCodeId,options={}){let path='/unique_coupon_codes/{unique_coupon_code_id}/restore';path=this._interpolatePath(path,{'unique_coupon_code_id':uniqueCouponCodeId});return this._makeRequest('PUT',path,null,options);}/**
   ...
   */async previewPurchase(body,options={}){let path='/purchases/preview';path=this._interpolatePath(path);return this._makeRequest('POST',path,body,options);}/**
   ...
   */async getExportDates(options={}){let path='/export_dates';path=this._interpolatePath(path);return this._makeRequest('GET',path,null,options);}/**
   ...
   */async getExportFiles(exportDate,options={}){let path='/export_dates/{export_date}/export_files';path=this._interpolatePath(path,{'export_date':exportDate});return this._makeRequest('GET',path,null,options);}}module.exports=Client;