 ...
 */class ItemMini extends Resource{static getSchema(){return{code:String,description:String,id:String,name:String,object:String,state:String};}}module.exports=ItemMini;