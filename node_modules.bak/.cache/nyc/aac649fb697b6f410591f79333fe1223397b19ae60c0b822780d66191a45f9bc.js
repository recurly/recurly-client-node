 ...
 */class Transaction extends Resource{static getSchema(){return{account:'AccountMini',amount:Number,avsCheck:String,billingAddress:'Address',collectedAt:Date,collectionMethod:String,createdAt:Date,currency:String,customerMessage:String,customerMessageLocale:String,cvvCheck:String,gatewayApprovalCode:String,gatewayMessage:String,gatewayReference:String,gatewayResponseCode:String,gatewayResponseTime:Number,gatewayResponseValues:Object,id:String,invoice:'InvoiceMini',ipAddressCountry:String,ipAddressV4:String,origin:String,originalTransactionId:String,paymentGateway:'TransactionPaymentGateway',paymentMethod:'PaymentMethod',refunded:Boolean,status:String,statusCode:String,statusMessage:String,subscriptionIds:Array,success:Boolean,type:String,uuid:String,voidedAt:Date,voidedByInvoice:'InvoiceMini'};}}module.exports=Transaction;