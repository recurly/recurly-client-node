 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   */async collectInvoice(invoiceId,params={}){const body=params['body'];let path='/invoices/{invoice_id}/collect';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,body,params);}/**
   ...
   */async terminateSubscription(subscriptionId,params={}){let path='/subscriptions/{subscription_id}';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('DELETE',path,null,params);}/**
   ...
   */async cancelSubscription(subscriptionId,params={}){const body=params['body'];let path='/subscriptions/{subscription_id}/cancel';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,body,params);}/**
