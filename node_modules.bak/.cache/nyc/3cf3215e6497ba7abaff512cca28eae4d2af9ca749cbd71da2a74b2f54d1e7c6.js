 ...
 */class SubscriptionChangePreview extends Resource{static getSchema(){return{activateAt:Date,activated:Boolean,addOns:['SubscriptionAddOn'],createdAt:Date,customFields:['CustomField'],deletedAt:Date,id:String,invoiceCollection:'InvoiceCollection',object:String,plan:'PlanMini',quantity:Number,revenueScheduleType:String,setupFeeRevenueScheduleType:String,shipping:'SubscriptionShipping',subscriptionId:String,unitAmount:Number,updatedAt:Date};}}module.exports=SubscriptionChangePreview;