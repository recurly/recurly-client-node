 ...
 */class CustomFieldDefinition extends Resource{static getSchema(){return{createdAt:Date,deletedAt:Date,displayName:String,id:String,name:String,object:String,relatedType:String,tooltip:String,updatedAt:Date,userAccess:String};}}module.exports=CustomFieldDefinition;