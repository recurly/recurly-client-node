 ...
 */class AddOn extends Resource{static getSchema(){return{accountingCode:String,code:String,createdAt:Date,currencies:['AddOnPricing'],defaultQuantity:Number,deletedAt:Date,displayQuantity:Boolean,externalSku:String,id:String,item:'ItemMini',name:String,object:String,optional:Boolean,planId:String,revenueScheduleType:String,state:String,taxCode:String,tierType:String,tiers:['Tier'],updatedAt:Date};}}module.exports=AddOn;