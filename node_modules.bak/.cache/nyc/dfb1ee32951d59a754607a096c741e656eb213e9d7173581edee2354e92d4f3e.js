 ...
 */class Client extends BaseClient{apiVersion(){return'v2019-10-10';}/**
   ...
   * Expire a coupon
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/expire_coupon}
   *
   *
   * @param {string} couponId - Coupon ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-10off`.
   * @return {Promise<Coupon>} The expired Coupon
   */async expireCoupon(couponId){let path='/coupons/{coupon_id}';path=this._interpolatePath(path,{'coupon_id':couponId});return this._makeRequest('DELETE',path,null);}/**
   ...
   */listItems(params={}){let path='/items';path=this._interpolatePath(path);return new Pager(this,path,params);}/**
   * Create a new item
   *
   ...
   */async collectInvoice(invoiceId,params={}){const body=params['body'];let path='/invoices/{invoice_id}/collect';path=this._interpolatePath(path,{'invoice_id':invoiceId});return this._makeRequest('PUT',path,body);}/**
   ...
   */async cancelSubscription(subscriptionId,params={}){const body=params['body'];let path='/subscriptions/{subscription_id}/cancel';path=this._interpolatePath(path,{'subscription_id':subscriptionId});return this._makeRequest('PUT',path,body);}/**
