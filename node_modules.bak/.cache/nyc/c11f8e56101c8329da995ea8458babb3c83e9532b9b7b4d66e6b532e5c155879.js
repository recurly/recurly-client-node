 ...
 */class Coupon extends Resource{static getSchema(){return{appliesToAllItems:Boolean,appliesToAllPlans:Boolean,appliesToNonPlanCharges:Boolean,bulkCouponCode:String,bulkCouponId:String,code:String,couponType:String,createdAt:Date,discount:'CouponDiscount',duration:String,expiredAt:Date,freeTrialAmount:Number,freeTrialUnit:String,hostedPageDescription:String,id:String,invoiceDescription:String,items:['ItemMini'],maxRedemptions:Number,maxRedemptionsPerAccount:Number,name:String,object:String,plans:['PlanMini'],plansNames:Array,redeemBy:Date,redeemedAt:Date,redemptionResource:String,state:String,temporalAmount:Number,temporalUnit:String,uniqueCodeTemplate:String,uniqueCouponCodesCount:Number,updatedAt:Date};}}module.exports=Coupon;