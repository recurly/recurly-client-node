 ...
 */class MeasuredUnit extends Resource{static getSchema(){return{createdAt:Date,deletedAt:Date,description:String,displayName:String,id:String,name:String,object:String,state:String,updatedAt:Date};}}module.exports=MeasuredUnit;