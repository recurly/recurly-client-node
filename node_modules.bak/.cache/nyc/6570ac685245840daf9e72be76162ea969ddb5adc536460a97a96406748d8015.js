 ...
 */class Invoice extends Resource{static getSchema(){return{account:'AccountMini',address:'InvoiceAddress',balance:Number,billingInfoId:String,closedAt:Date,collectionMethod:String,createdAt:Date,creditPayments:['CreditPayment'],currency:String,customerNotes:String,discount:Number,dueAt:Date,id:String,lineItems:'LineItemList',netTerms:Number,number:String,object:String,origin:String,paid:Number,poNumber:String,previousInvoiceId:String,refundableAmount:Number,shippingAddress:'ShippingAddress',state:String,subscriptionIds:Array,subtotal:Number,tax:Number,taxInfo:'TaxInfo',termsAndConditions:String,total:Number,transactions:['Transaction'],type:String,updatedAt:Date,vatNumber:String,vatReverseChargeNotes:String};}}module.exports=Invoice;