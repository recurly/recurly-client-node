 ...
 */class Subscription extends Resource{static getSchema(){return{account:'AccountMini',activatedAt:Date,addOns:['SubscriptionAddOn'],addOnsTotal:Number,autoRenew:Boolean,bankAccountAuthorizedAt:Date,canceledAt:Date,collectionMethod:String,couponRedemptions:['CouponRedemptionMini'],createdAt:Date,currency:String,currentPeriodEndsAt:Date,currentPeriodStartedAt:Date,currentTermEndsAt:Date,currentTermStartedAt:Date,customFields:['CustomField'],customerNotes:String,expirationReason:String,expiresAt:Date,id:String,netTerms:Number,object:String,pausedAt:Date,pendingChange:'SubscriptionChange',plan:'PlanMini',poNumber:String,quantity:Number,remainingBillingCycles:Number,remainingPauseCycles:Number,renewalBillingCycles:Number,revenueScheduleType:String,shipping:'SubscriptionShipping',state:String,subtotal:Number,termsAndConditions:String,totalBillingCycles:Number,trialEndsAt:Date,trialStartedAt:Date,unitAmount:Number,updatedAt:Date,uuid:String};}}module.exports=Subscription;