...
class Client extends BaseClient {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/verify_billing_infos}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   * @return {Promise<Transaction>} Transaction information from verify.
   */
  async verifyBillingInfos (accountId, billingInfoId, options = {}) {
    const body = options['body']
    let path = '/accounts/{account_id}/billing_infos/{billing_info_id}/verify'
    path = this._interpolatePath(path, { 'account_id': accountId, 'billing_info_id': billingInfoId })
    return this._makeRequest('POST', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/verify_billing_infos_cvv}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   * @return {Promise<Transaction>} Transaction information from verify.
   */
  async verifyBillingInfosCvv (accountId, billingInfoId, body, options = {}) {
    let path = '/accounts/{account_id}/billing_infos/{billing_info_id}/verify_cvv'
    path = this._interpolatePath(path, { 'account_id': accountId, 'billing_info_id': billingInfoId })
    return this._makeRequest('POST', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/list_account_external_account}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
  ...
  listAccountExternalAccount (accountId, options = {}) {
    let path = '/accounts/{account_id}/external_accounts'
    path = this._interpolatePath(path, { 'account_id': accountId })
    return new Pager(this, path, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_account_external_account}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {ExternalAccountCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {ExternalAccountCreate}
   * @return {Promise<ExternalAccount>} A representation of the created external_account.
   */
  async createAccountExternalAccount (accountId, body, options = {}) {
    let path = '/accounts/{account_id}/external_accounts'
    path = this._interpolatePath(path, { 'account_id': accountId })
    return this._makeRequest('POST', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/get_account_external_account}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} externalAccountId - External account ID, e.g. `s28zov4fw0cb`.
   * @return {Promise<ExternalAccount>} A external account on an account.
   */
  async getAccountExternalAccount (accountId, externalAccountId, options = {}) {
    let path = '/accounts/{account_id}/external_accounts/{external_account_id}'
    path = this._interpolatePath(path, { 'account_id': accountId, 'external_account_id': externalAccountId })
    return this._makeRequest('GET', path, null, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/update_account_external_account}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} externalAccountId - External account ID, e.g. `s28zov4fw0cb`.
   * @param {ExternalAccountUpdate} body - The object representing the JSON request to send to the server. It should conform to the schema of {ExternalAccountUpdate}
   * @return {Promise<ExternalAccount>} A representation of the updated external_account.
   */
  async updateAccountExternalAccount (accountId, externalAccountId, body, options = {}) {
    let path = '/accounts/{account_id}/external_accounts/{external_account_id}'
    path = this._interpolatePath(path, { 'account_id': accountId, 'external_account_id': externalAccountId })
    return this._makeRequest('PUT', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/delete_account_external_account}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} externalAccountId - External account ID, e.g. `s28zov4fw0cb`.
   * @return {Promise<ExternalAccount>} Successful Delete
   */
  async deleteAccountExternalAccount (accountId, externalAccountId, options = {}) {
    let path = '/accounts/{account_id}/external_accounts/{external_account_id}'
    path = this._interpolatePath(path, { 'account_id': accountId, 'external_account_id': externalAccountId })
    return this._makeRequest('DELETE', path, null, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/list_account_external_invoices}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {Object} options - Optional configurations for the request
  ...
  listAccountExternalInvoices (accountId, options = {}) {
    let path = '/accounts/{account_id}/external_invoices'
    path = this._interpolatePath(path, { 'account_id': accountId })
    return new Pager(this, path, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_account_note}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   ...
   */
  async createAccountNote (accountId, body, options = {}) {
    let path = '/accounts/{account_id}/notes'
    path = this._interpolatePath(path, { 'account_id': accountId })
    return this._makeRequest('POST', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/remove_account_note}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} accountNoteId - Account Note ID.
   ...
   */
  async removeAccountNote (accountId, accountNoteId, options = {}) {
    let path = '/accounts/{account_id}/notes/{account_note_id}'
    path = this._interpolatePath(path, { 'account_id': accountId, 'account_note_id': accountNoteId })
    return this._makeRequest('DELETE', path, null, options)
  }
...
endpoint to obtain only the newly generated `UniqueCouponCodes`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/list_external_subscription_external_invoices}
   *
   *
   * @param {string} externalSubscriptionId - External subscription id
   * @param {Object} options - Optional configurations for the request
  ...
  listExternalSubscriptionExternalInvoices (externalSubscriptionId, options = {}) {
    let path = '/external_subscriptions/{external_subscription_id}/external_invoices'
    path = this._interpolatePath(path, { 'external_subscription_id': externalSubscriptionId })
    return new Pager(this, path, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_external_invoice}
   *
   *
   * @param {string} externalSubscriptionId - External subscription id
   ...
   */
  async createExternalInvoice (externalSubscriptionId, body, options = {}) {
    let path = '/external_subscriptions/{external_subscription_id}/external_invoices'
    path = this._interpolatePath(path, { 'external_subscription_id': externalSubscriptionId })
    return this._makeRequest('POST', path, body, options)
  }
   ...
   */
  async applyCreditBalance (invoiceId, options = {}) {
    let path = '/invoices/{invoice_id}/apply_credit_balance'
    path = this._interpolatePath(path, { 'invoice_id': invoiceId })
    return this._makeRequest('PUT', path, null, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_invoice_retry}
   *
   *
   ...
   * @return {Promise<InvoiceCollection>} Returns the new invoices.
   */
  async createInvoiceRetry (body, options = {}) {
    let path = '/invoices/recovery'
    path = this._interpolatePath(path)
    return this._makeRequest('POST', path, body, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/list_price_segments}
   *
   *
   * @param {Object} options - Optional configurations for the request
   * @param {Object} options.params - The optional url parameters for this request.
   ...
   */
  listPriceSegments (options = {}) {
    let path = '/price_segments'
    path = this._interpolatePath(path)
    return new Pager(this, path, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/get_price_segment}
   *
   *
   ...
   */
  async getPriceSegment (priceSegmentId, options = {}) {
    let path = '/price_segments/{price_segment_id}'
    path = this._interpolatePath(path, { 'price_segment_id': priceSegmentId })
    return this._makeRequest('GET', path, null, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_authorize_purchase}
   *
   *
   * @param {PurchaseCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {PurchaseCreate}
   * @return {Promise<InvoiceCollection>} Returns the authorize invoice
   */
  async createAuthorizePurchase (body, options = {}) {
    let path = '/purchases/authorize'
    path = this._interpolatePath(path)
    return this._makeRequest('POST', path, body, options)
  }
   ...
   * Capture a purchase
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/create_capture_purchase}
   *
   *
   * @param {string} transactionId - Transaction ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @return {Promise<InvoiceCollection>} Returns the captured invoice
   */
  async createCapturePurchase (transactionId, options = {}) {
    let path = '/purchases/{transaction_id}/capture'
    path = this._interpolatePath(path, { 'transaction_id': transactionId })
    return this._makeRequest('POST', path, null, options)
  }

  /**
   * Cancel Purchase
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/cancelPurchase}
   *
   *
   * @param {string} transactionId - Transaction ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @return {Promise<InvoiceCollection>} Returns the cancelled invoice
   */
  async cancelpurchase (transactionId, options = {}) {
    let path = '/purchases/{transaction_id}/cancel/'
    path = this._interpolatePath(path, { 'transaction_id': transactionId })
    return this._makeRequest('POST', path, null, options)
  }
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/list_external_invoices}
   *
   *
   * @param {Object} options - Optional configurations for the request
   * @param {Object} options.params - The optional url parameters for this request.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2021-02-25#operation/show_external_invoice}
   *
   *
   * @param {string} externalInvoiceId - External invoice ID, e.g. `e28zov4fw0v2`.
   * @return {Promise<ExternalInvoice>} Returns the external invoice
   */
  async showExternalInvoice (externalInvoiceId, options = {}) {
    let path = '/external_invoices/{external_invoice_id}'
    path = this._interpolatePath(path, { 'external_invoice_id': externalInvoiceId })
    return this._makeRequest('GET', path, null, options)
  }
  ...
  listEntitlements (accountId, options = {}) {
    let path = '/accounts/{account_id}/entitlements'
    path = this._interpolatePath(path, { 'account_id': accountId })
    return new Pager(this, path, options)
  }
