...
class Client extends BaseClient {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/verify_billing_info}
   *
   * @example
   * try {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/verify_billing_info_cvv}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/list_billing_infos}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {Object} options - The optional url parameters for this request.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/create_billing_info}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {BillingInfoCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {BillingInfoCreate}
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_a_billing_info}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/update_a_billing_info}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   * Remove an account's billing information
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/remove_a_billing_info}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/verify_billing_infos}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/verify_billing_infos_cvv}
   *
   *
   * @param {string} accountId - Account ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-bob`.
   * @param {string} billingInfoId - Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/restore_coupon}
   *
   * @example
   * try {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/create_measured_unit}
   *
   *
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_measured_unit}
   *
   *
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/update_measured_unit}
   *
   *
   * @param {string} measuredUnitId - Measured unit ID or name. For ID no prefix is used e.g. `e28zov4fw0v2`. For name use prefix `name-`, e.g. `name-Storage`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/remove_measured_unit}
   *
   *
   * @param {string} measuredUnitId - Measured unit ID or name. For ID no prefix is used e.g. `e28zov4fw0v2`. For name use prefix `name-`, e.g. `name-Storage`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/apply_credit_balance}
   *
   * @example
   * try {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/create_shipping_method}
   *
   *
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/update_shipping_method}
   *
   *
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/deactivate_shipping_method}
   *
   *
   * @param {string} shippingMethodId - Shipping Method ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-usps_2-day`.
   * @return {Promise<ShippingMethod>} A shipping method.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/preview_subscription_change}
   *
   *
   * @param {string} subscriptionId - Subscription ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @param {SubscriptionChangeCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {SubscriptionChangeCreate}
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/list_usage}
   *
   *
   * @param {string} subscriptionId - Subscription ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @param {string} addOnId - Add-on ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-gold`.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/create_usage}
   *
   *
   * @param {string} subscriptionId - Subscription ID or UUID. For ID no prefix is used e.g. `e28zov4fw0v2`. For UUID use prefix `uuid-`, e.g. `uuid-123457890`.
   * @param {string} addOnId - Add-on ID or code. For ID no prefix is used e.g. `e28zov4fw0v2`. For code use prefix `code-`, e.g. `code-gold`.
   ...
   * Get a usage record
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_usage}
   *
   *
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/update_usage}
   *
   *
   * @param {string} usageId - Usage Record ID.
   * @param {UsageCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {UsageCreate}
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/remove_usage}
   *
   *
   * @param {string} usageId - Usage Record ID.
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_export_dates}
   *
   * @example
   * try {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_export_files}
   *
   * @example
   * try {
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/list_dunning_campaigns}
   *
   *
   * @param {Object} options - The optional url parameters for this request.
   * @param {string} options.sort - Sort field. You *really* only want to sort by `updated_at` in ascending
   ...
   *
   * API docs: {@link https://developers.recurly.com/api/v2019-10-10#operation/get_dunning_campaign}
   *
   *
