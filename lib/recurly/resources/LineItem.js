 ...
 * @prop {number} discount - The sum of all discounts applied to the line item.
 * @prop {Array.<LineItemDiscount>} discounts - The breakdown of discounts applied to the line item by coupon redemption.
 ...
 * @prop {string} liabilityGlAccountCode - Unique code to identify the ledger account. Each code must start with a letter or number. The following special characters are allowed: `-_.,:`
 ...
 * @prop {string} revenueGlAccountCode - Unique code to identify the ledger account. Each code must start with a letter or number. The following special characters are allowed: `-_.,:`
