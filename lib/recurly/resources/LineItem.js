 ...
 * @prop {string} externalSku - Optional Stock Keeping Unit assigned to an item, when the Catalog feature is enabled.
 ...
 * @prop {string} itemCode - Unique code to identify an item, when the Catalog feature is enabled.
 * @prop {string} itemId - Available when the Catalog feature is enabled.
