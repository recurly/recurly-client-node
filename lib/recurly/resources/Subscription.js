 ...
 * @prop {Date} resumeAt - The date the subscription billing resumes following a pause. Null unless the subscription is paused or scheduled to be paused.
...
class Subscription extends Resource {
  static getSchema () {
    return {
      ...
      createdAt: Date,
      creditApplicationPolicy: 'CreditApplicationPolicy',
      currency: String,
