 ...
 * @prop {Array.<PlanPricing>} currencies - Present only when `pricing_model` is `'fixed'`.
 ...
 * @prop {string} pricingModel - A fixed pricing model has the same price for each billing period. A ramp pricing model defines a set of Ramp Intervals, where a subscription changes price on a specified cadence of billing periods. The price change could be an increase or decrease.
 * @prop {Array.<PlanRampInterval>} rampIntervals - Ramp Intervals
 ...
 * @prop {string} setupFeeLiabilityGlAccountId - The ID of a general ledger account. General ledger accounts are only accessible as a part of the Recurly RevRec Standard and Recurly RevRec Advanced features.
 * @prop {string} setupFeePerformanceObligationId - The ID of a performance obligation. Performance obligations are only accessible as a part of the Recurly RevRec Standard and Recurly RevRec Advanced features.
 * @prop {string} setupFeeRevenueGlAccountId - The ID of a general ledger account. General ledger accounts are only accessible as a part of the Recurly RevRec Standard and Recurly RevRec Advanced features.
 * @prop {string} setupFeeRevenueScheduleType - Setup fee revenue schedule type
 * @prop {Array.<PlanSetupPricing>} setupFees - Setup Fees
