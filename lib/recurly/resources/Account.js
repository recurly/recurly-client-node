 ...
 * @prop {Date} billDate - The preferred billing date for the account. This date will be used as the billing date for when activating new subscriptions on the account.
 ...
 * @prop {string} id
 * @prop {string} invoiceTemplateId - Unique ID to identify an invoice template. Available when the site is on a Pro or Elite plan. Used to specify if a non-default invoice template will be used to generate invoices for the account. For sites without multiple invoice templates enabled, the default template will always be used.
